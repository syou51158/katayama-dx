            ...
            <div className="flex items-center flex-shrink-0">
              <div className="flex-shrink-0 mr-2">
                <div className="flex flex-col">
                  ...
                  {user && (
                    <span className="text-xs text-white/60 pl-10 truncate max-w-[160px]">
                      {user.email}
                    </span>
                  )}
                </div>
              </div>
              <div className="hidden lg:block ml-1 flex-1 overflow-x-auto">
                <div className="flex flex-nowrap items-center space-x-0.5">
                  {navLinks.map((link) => (
                    <NavLink
                      key={link.path}
                      to={link.path}
                      className={`px-1.5 py-1.5 rounded text-[0.7rem] font-medium transition duration-150 flex items-center space-x-0.5 ${
